...
// Formats signature types the way they are shown in stack frame names: C# keywords for primitives,
// namespace-qualified names for everything else and generic instantiations as 'List<int>'
internal sealed class DisplayNameSignatureProvider : ISignatureTypeProvider<string, object?> {
    public static DisplayNameSignatureProvider Instance { get; } = new DisplayNameSignatureProvider();
