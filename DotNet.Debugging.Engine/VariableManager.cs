...
public enum StoredReferenceKind {
    ...
    NonPublicStackVariable, // The 'Non-Public members' pseudo variable of a "StackVariable" class
    NonPublicStaticClassVariable, // The 'Non-Public members' pseudo variable of a "StaticClassVariable" group
}
