...
public partial class ManagedDebugger {
    private static string GetDecimalValueString(ICorDebugObjectValue corDebugObjectValue) {
        ...
        var classToken = corDebugObjectValue.GetClass().GetToken();
        ...
        foreach (var fieldDef in metaDataImport.EnumFields(classToken)) {
            ...
            uint ReadUInt32Field() {
                var fieldValue = corDebugObjectValue.GetFieldValue(corDebugObjectValue.GetClass(), fieldDef);
            ...
            switch (name) {
                ...
                case "_lo64":
                    ...
                    var fieldValue64 = corDebugObjectValue.GetFieldValue(corDebugObjectValue.GetClass(), fieldDef);
