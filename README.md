...
* DotNet.Debugging.Evaluation: The Roslyn C# expression compiler rebuilt from its sources for DotNet.Debugging.Engine. See [docs/evaluation](docs/evaluation/README.md).
